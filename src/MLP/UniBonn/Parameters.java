...
public class Parameters extends JFrame {
    ...
    private final String titleFrame = "MLP - Parameters - NAO Robot Database";
    ...
    private String modelFileName = "uniBonn-model.dat";
    private String prevModelFileName;
    
    private int MaxTraining = 598;
    private int MaxTesting = 255;
