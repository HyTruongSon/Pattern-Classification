...
public class Parameters extends JFrame {
    ...
    private final String titleFrame = "MLP - Parameters - Hy Truong Son's lower case handwriting database";
    ...
    private final int nInput = 2500;
    private final int nOutput = 26;
    ...
    private String modelFileName = "HTS-lower-model.dat";
    private String prevModelFileName;
    
    private int MaxTraining = 11599;
    private int MaxTesting = 7733;
