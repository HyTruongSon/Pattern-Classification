...
public class Parameters extends JFrame {
    ...
    private final String titleFrame = "MLP - Parameters - Hy Truong Son's upper case handwriting database";
    ...
    private String modelFileName = "HTS-upper-model.dat";
    private String prevModelFileName;
    
    private int MaxTraining = 11470;
    private int MaxTesting = 7647;
