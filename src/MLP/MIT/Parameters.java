...
public class Parameters extends JFrame {
    ...
    private final String titleFrame = "MLP - Parameters - MIT CBCL Face Database";
    ...
    private final int nInput = 361;
    private final int nOutput = 2;
    ...
    private String modelFileName = "mit-cbcl-model.dat";
    private String prevModelFileName;
    
    private int MaxTraining = 6977;
    private int MaxTesting = 24045;
